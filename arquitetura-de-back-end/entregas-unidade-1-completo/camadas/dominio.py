...
class Horario:
    ...
    def conflita_com(self, outro: Horario) -> bool:
        ...
        ALTERAÇÃO (experimento Camadas): antes, dois horários "encostados"
        (um começando exatamente no instante em que o outro termina) NÃO
        eram considerados conflito. Agora, para dar uma folga mínima entre
        consultas, esse caso também é tratado como conflito (uso de <= / >=
        em vez de < / >).
        """
