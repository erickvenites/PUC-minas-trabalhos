...
def main():
    ...
    secao("10. [EXPERIMENTO] Agendamento 'encostado' (começa exatamente onde outra termina)")
    print("    Dr. João tem consulta das 14:00 às 14:20. Tentando agendar outra")
    print("    para o mesmo médico começando exatamente às 14:20:")
    print(controller.post_consulta({
        "paciente_id": 1, "medico_id": 2,
        "inicio": "2025-06-10T14:20:00", "fim": "2025-06-10T14:40:00",
    }))
